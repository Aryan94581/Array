public class A_shadow {
    ...
    public static void main(String[] args) {
        System.out.println(A); // we are able to access it because int A is declared in a higher scope.  
    ...
    //   output is 5 because we shadowed the main A to different value which can be accessed by only in main class
    }
    {
        // wha now ?
